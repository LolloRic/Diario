...
2. elimina il file da_eliminare.txt dalla directory/cartella database

3. in crea_database.txt e riavvio_database.txt cambia i percorsi
...
OPZIONALE:
3+. una volta cambiati i percorsi, puoi cambiare l'estensione dei file in:
	- crea_database.bat
